 ...
 */
final class Version20251103133222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE permission (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, route VARCHAR(100) NOT NULL, description VARCHAR(255) DEFAULT NULL, public_access TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E04992AA5E237E06 (name), UNIQUE INDEX UNIQ_E04992AA2C42079 (route), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE role ADD hierarchy_level INT NOT NULL');
    }
