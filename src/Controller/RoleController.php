...
final class RoleController extends AbstractController
{
    ...
    #[Route('/debug-new', name: 'app_role_debug_new', methods: ['GET', 'POST'])]
    public function debugNew(Request $request, EntityManagerInterface $entityManager): Response
    {
        $role = new Role();
        $form = $this->createForm(RoleType::class, $role);
        $form->handleRequest($request);

        return $this->render('role/debug_new.html.twig', [
            'role' => $role,
            'form' => $form,
        ]);
    }
